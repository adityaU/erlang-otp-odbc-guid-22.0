...
OpCase(hot_is_function2_fSt):
{
  ...
  if (!is_function2(Sb(tmp_packed1&BEAM_LOOSE_MASK), tb((tmp_packed1>>BEAM_LOOSE_SHIFT)))) {
...
{
  Eterm tmp_packed1 = I[2];
  Eterm res = get_map_element(xb(tmp_packed1&BEAM_TIGHT_MASK), yb((tmp_packed1>>BEAM_TIGHT_SHIFT)&BEAM_TIGHT_MASK));
  if (is_non_value(res)) {
    ASSERT(VALID_INSTR(*(I + (I[1]) + 0)));
    I += I[1] + 0;;
    Goto(*I);;
...
{
  Eterm tmp_packed1 = I[2];
  Eterm res = get_map_element(yb(tmp_packed1&BEAM_TIGHT_MASK), yb((tmp_packed1>>BEAM_TIGHT_SHIFT)&BEAM_TIGHT_MASK));
  if (is_non_value(res)) {
    ASSERT(VALID_INSTR(*(I + (I[1]) + 0)));
    I += I[1] + 0;;
    Goto(*I);;
...
OpCase(i_get_tuple_element2_dst_xPxx):
{
  ...
  E1 = src[0];
  E2 = src[1];
  xb((tmp_packed1>>BEAM_TIGHT_SHIFT)&BEAM_TIGHT_MASK) = E1;
  xb((tmp_packed1>>(2*BEAM_TIGHT_SHIFT))) = E2;
  I += 3;
  ASSERT(VALID_INSTR(next_pf));
  GotoPF(next_pf);
}
...
OpCase(i_int_bnot_jSd):
{
  ...
  Eterm* dst_ptr = REG_TARGET_PTR(dst);
  Eterm bnot_val = Sb(tmp_packed1&BEAM_LOOSE_MASK);
  Eterm result;
...
OpCase(i_length_setup_tx):
{
  ...
  Eterm src = xb((tmp_packed1>>BEAM_LOOSE_SHIFT));
...
OpCase(i_length_setup_ty):
{
  Eterm tmp_packed1 = I[1];
  Uint live = tb(tmp_packed1&BEAM_LOOSE_MASK);
  Eterm src = yb((tmp_packed1>>BEAM_LOOSE_SHIFT));
...

{
  ...
  OpCase(i_minus_xyjd):
  {
    Eterm tmp_packed1 = I[1];
    MinusOp1 = xb(tmp_packed1&BEAM_LOOSE_MASK);
    MinusOp2 = yb((tmp_packed1>>BEAM_LOOSE_SHIFT));
  }
  goto minus__execute;
  ...
  {
    Eterm tmp_packed1 = I[1];
    MinusOp1 = yb(tmp_packed1&BEAM_LOOSE_MASK);
    MinusOp2 = xb((tmp_packed1>>BEAM_LOOSE_SHIFT));
  }
  goto minus__execute;
...

{
  ...
  {
    Eterm tmp_packed1 = I[1];
    PlusOp1 = yb(tmp_packed1&BEAM_LOOSE_MASK);
    PlusOp2 = xb((tmp_packed1>>BEAM_LOOSE_SHIFT));
  }
  goto plus__execute;
...
OpCase(is_eq_fSs):
{
  ...
  GetSource(I[2], targ1);
  {
    Eterm a = Sb((tmp_packed1>>BEAM_WIDE_SHIFT));
    Eterm b = targ1;
    CMP_EQ_ACTION(a, b, ASSERT(VALID_INSTR(*(I + (fb(tmp_packed1&BEAM_WIDE_MASK)) + 0)));
    I += fb(tmp_packed1&BEAM_WIDE_MASK) + 0;;
    Goto(*I););
    I += 3;
    ASSERT(VALID_INSTR(*I));
...
OpCase(is_ne_fSs):
{
  ...
  GetSource(I[2], targ1);
  {
    Eterm a = Sb((tmp_packed1>>BEAM_WIDE_SHIFT));
    Eterm b = targ1;
    CMP_NE_ACTION(a, b, ASSERT(VALID_INSTR(*(I + (fb(tmp_packed1&BEAM_WIDE_MASK)) + 0)));
    I += fb(tmp_packed1&BEAM_WIDE_MASK) + 0;;
    Goto(*I););
    I += 3;
    ASSERT(VALID_INSTR(*I));
...
{
  Eterm tmp_packed1 = I[2];
  if (is_not_list(xb(tmp_packed1&BEAM_LOOSE_MASK))) {
    ASSERT(VALID_INSTR(*(I + (I[1]) + 0)));
    I += I[1] + 0;;
    Goto(*I);;
  };
...
{
  Eterm tmp_packed1 = I[1];
  Eterm lbl = fb(tmp_packed1&BEAM_WIDE_MASK);
  Eterm src = I[2];
  xb((tmp_packed1>>BEAM_WIDE_SHIFT)) = src;
  ASSERT(VALID_INSTR(*(I + (lbl) + 0)));
  I += lbl + 0;;
  Goto(*I);;
}
...
OpCase(move_jump_fcy):
{
  ...
  Eterm lbl = fb(tmp_packed1&BEAM_WIDE_MASK);
  Eterm src = I[2];
  yb((tmp_packed1>>BEAM_WIDE_SHIFT)) = src;
  ASSERT(VALID_INSTR(*(I + (lbl) + 0)));
  I += lbl + 0;;
  Goto(*I);;
}
...
OpCase(move_jump_fxx):
{
  Eterm tmp_packed1 = I[2];
  Eterm lbl = I[1];
  Eterm src = xb(tmp_packed1&BEAM_LOOSE_MASK);
  xb((tmp_packed1>>BEAM_LOOSE_SHIFT)) = src;
  ASSERT(VALID_INSTR(*(I + (lbl) + 0)));
  I += lbl + 0;;
  Goto(*I);;
...
OpCase(move_shift_cxx):
{
  ...
  xb(tmp_packed1&BEAM_LOOSE_MASK) = V;
  I += 3;
  ASSERT(VALID_INSTR(next_pf));
  GotoPF(next_pf);
}
...
OpCase(move_shift_nyx):
{
  ...
  yb(tmp_packed1&BEAM_LOOSE_MASK) = V;
  I += 2;
  ASSERT(VALID_INSTR(next_pf));
  GotoPF(next_pf);
}
...
OpCase(move_shift_yry):
{
  ...
  BeamInstr next_pf = BeamCodeAddr(I[2]);
  Eterm V;
  V = yb(tmp_packed1&BEAM_LOOSE_MASK);
  yb((tmp_packed1>>BEAM_LOOSE_SHIFT)) = r(0);
  r(0) = V;
  I += 2;
  ASSERT(VALID_INSTR(next_pf));
  GotoPF(next_pf);
...
OpCase(move_src_window2_yxx):
{
  Eterm tmp_packed1 = I[1];
  BeamInstr next_pf = BeamCodeAddr(I[2]);
  Eterm* src = &yb(tmp_packed1&BEAM_TIGHT_MASK);
  Eterm s1, s2;
  s1 = src[0];
  s2 = src[1];
  xb((tmp_packed1>>BEAM_TIGHT_SHIFT)&BEAM_TIGHT_MASK) = s1;
  xb((tmp_packed1>>(2*BEAM_TIGHT_SHIFT))) = s2;
  I += 2;
  ASSERT(VALID_INSTR(next_pf));
  GotoPF(next_pf);
}
...
OpCase(move_window2_xxy):
{
  ...
  BeamInstr next_pf = BeamCodeAddr(I[2]);
  Eterm xt0, xt1;
  Eterm* y = &yb((tmp_packed1>>(2*BEAM_TIGHT_SHIFT)));
...
OpCase(swap_yx):
{
  Eterm tmp_packed1 = I[1];
  BeamInstr next_pf = BeamCodeAddr(I[2]);
  Eterm V = yb(tmp_packed1&BEAM_LOOSE_MASK);
  yb(tmp_packed1&BEAM_LOOSE_MASK) = xb((tmp_packed1>>BEAM_LOOSE_SHIFT));
  xb((tmp_packed1>>BEAM_LOOSE_SHIFT)) = V;
  I += 2;
  ASSERT(VALID_INSTR(next_pf));
  GotoPF(next_pf);
...
OpCase(swap_yy):
{
  ...
  BeamInstr next_pf = BeamCodeAddr(I[2]);
  Eterm V = yb(tmp_packed1&BEAM_LOOSE_MASK);
  yb(tmp_packed1&BEAM_LOOSE_MASK) = yb((tmp_packed1>>BEAM_LOOSE_SHIFT));
...
{
  Eterm tmp_packed1 = I[2];
  Eterm* ptr = tuple_val(xb(tmp_packed1&BEAM_LOOSE_MASK));
  Eterm* src;
  if (*ptr != I[3]) {
    ASSERT(VALID_INSTR(*(I + (I[1]) + 0)));
    I += I[1] + 0;;
