 ...
 *       'make_alloc_types' on Fri Aug 19 02:15:54 2022.
 *
 * -----------------------------------------------------------------------
 *
 * 
...
#define ERTS_ALC_N_MAX_A_STANDARD (128)

/* Type numbers used for ll_alloc */
#define ERTS_ALC_N_MIN_A_LONG_LIVED (129)
...
#define ERTS_ALC_N_MAX_A_ETS (184)

/* Type numbers used for fix_alloc */
#define ERTS_ALC_N_MIN_A_FIXED_SIZE (185)
#define ERTS_ALC_N_MAX_A_FIXED_SIZE (197)

/* Type numbers used for literal_alloc */
#define ERTS_ALC_N_MIN_A_LITERAL (198)
#define ERTS_ALC_N_MAX_A_LITERAL (198)

/* Type numbers used for exec_alloc */
#define ERTS_ALC_N_MIN_A_EXEC (199)
#define ERTS_ALC_N_MAX_A_EXEC (199)

/* Type numbers used for binary_alloc */
#define ERTS_ALC_N_MIN_A_BINARY (200)
#define ERTS_ALC_N_MAX_A_BINARY (201)

/* Type numbers used for driver_alloc */
#define ERTS_ALC_N_MIN_A_DRIVER (202)
#define ERTS_ALC_N_MAX_A_DRIVER (216)

/* Type numbers used for test_alloc */
#define ERTS_ALC_N_MIN_A_TEST (217)
#define ERTS_ALC_N_MAX_A_TEST (217)

#define ERTS_ALC_N_MAX (217)
...
#define ERTS_ALC_T_DCACHE (12004)
#define ERTS_ALC_T_DIST_ENTRY (12132)
#define ERTS_ALC_T_NODE_ENTRY (12260)
#define ERTS_ALC_T_ARG_REG (12372)
#define ERTS_ALC_T_PROC_DICT (12500)
#define ERTS_ALC_T_CALLS_BUF (12628)
#define ERTS_ALC_T_BPD (12772)
#define ERTS_ALC_T_LINEBUF (12900)
#define ERTS_ALC_T_IOQ (13028)
#define ERTS_ALC_T_BITS_BUF (13156)
#define ERTS_ALC_T_DB_NTAB_ENT (13252)
#define ERTS_ALC_T_DDLL_HANDLE (13412)
#define ERTS_ALC_T_RE_HEAP (13540)
#define ERTS_ALC_T_PSD (13652)
#define ERTS_ALC_T_PRTSD (13796)
#define ERTS_ALC_T_MREF_ENT (13924)
#define ERTS_ALC_T_MREF_TAB_BKTS (14052)
#define ERTS_ALC_T_CRASH_DUMP (14180)
#define ERTS_ALC_T_THR_Q_EL (14308)
#define ERTS_ALC_T_THR_Q (14436)
#define ERTS_ALC_T_ZLIB (14564)
#define ERTS_ALC_T_DRIVER_LOCK (14692)
#define ERTS_ALC_T_ML_DIST (14820)
#define ERTS_ALC_T_ETHR_STD (14948)
#define ERTS_ALC_T_HIPE_STK (15076)
#define ERTS_ALC_T_DDLL_PROCESS (15204)
#define ERTS_ALC_T_MONITOR_EXT (15316)
#define ERTS_ALC_T_LINK_EXT (15444)
#define ERTS_ALC_T_DB_HEIR_DATA (15556)
#define ERTS_ALC_T_NIF_TRAP_EXPORT (15700)
#define ERTS_ALC_T_MONITOR_SUSPEND (15828)
#define ERTS_ALC_T_PORT_DATA_HEAP (15972)
#define ERTS_ALC_T_ATOMICS (16100)
#define ERTS_ALC_T_COUNTERS (16228)
#define ERTS_ALC_T_FD_ENTRY_BUF (16356)
#define ERTS_ALC_T_SYS_BLOCKING (16484)
#define ERTS_ALC_T_ATOM (16533)
#define ERTS_ALC_T_MODULE (16693)
#define ERTS_ALC_T_FUN_ENTRY (16821)
#define ERTS_ALC_T_ATOM_TXT (16917)
#define ERTS_ALC_T_TIMER_SERVICE (17125)
#define ERTS_ALC_T_ATOM_TABLE (17173)
#define ERTS_ALC_T_EXPORT_TABLE (17333)
#define ERTS_ALC_T_MODULE_TABLE (17461)
#define ERTS_ALC_T_TAINT (17589)
#define ERTS_ALC_T_PROC_TABLE (17749)
#define ERTS_ALC_T_PORT_TABLE (17893)
#define ERTS_ALC_T_TIMER_WHEEL (18021)
#define ERTS_ALC_T_ASYNC_DATA (18149)
#define ERTS_ALC_T_DB_TABLES (18245)
#define ERTS_ALC_T_SCHDLR_SLP_INFO (18405)
#define ERTS_ALC_T_RUNQS (18533)
#define ERTS_ALC_T_DDLL_ERRCODES (18661)
#define ERTS_ALC_T_PRE_ALLOC_DATA (18789)
#define ERTS_ALC_T_CPUDATA (18917)
#define ERTS_ALC_T_CPU_GRPS_MAP (19045)
#define ERTS_ALC_T_MISC_AUX_WORK_Q (19173)
#define ERTS_ALC_T_TRACER_NIF (19301)
#define ERTS_ALC_T_MREF_TAB (19429)
#define ERTS_ALC_T_THR_Q_LL (19557)
#define ERTS_ALC_T_RUNQ_BLNS (19685)
#define ERTS_ALC_T_THR_PRGR_IDATA (19813)
#define ERTS_ALC_T_THR_PRGR_DATA (19941)
#define ERTS_ALC_T_PERSISTENT_TERM (20021)
#define ERTS_ALC_T_ETHR_LL (20197)
#define ERTS_ALC_T_FP_EXCEPTION (20325)
#define ERTS_ALC_T_LL_MPATHS (20453)
#define ERTS_ALC_T_HIPE_LL (20581)
#define ERTS_ALC_T_CODE (20661)
#define ERTS_ALC_T_DB_MS_PSDO_PROC (20805)
#define ERTS_ALC_T_SCHDLR_DATA (20965)
#define ERTS_ALC_T_EXPORT (21045)
#define ERTS_ALC_T_DRV_TAB (21221)
#define ERTS_ALC_T_DRV_EV_STATE (21349)
#define ERTS_ALC_T_POLLSET (21477)
#define ERTS_ALC_T_POLL_FDS (21605)
#define ERTS_ALC_T_FD_STATUS (21733)
#define ERTS_ALC_T_SELECT_FDS (21861)
...
#define ERTS_ALC_T_DB_STK (22983)
#define ERTS_ALC_T_DB_TRANS_TAB (23111)
#define ERTS_ALC_T_DB_SEL_LIST (23239)
#define ERTS_ALC_T_DB_DMC_ERROR (23367)
#define ERTS_ALC_T_DB_DMC_ERR_INFO (23495)
#define ERTS_ALC_T_DB_TERM (23623)
#define ERTS_ALC_T_PROC (23768)
#define ERTS_ALC_T_MSG_REF (23896)
#define ERTS_ALC_T_LL_PTIMER (24024)
#define ERTS_ALC_T_HL_PTIMER (24152)
#define ERTS_ALC_T_BIF_TIMER (24280)
#define ERTS_ALC_T_MREF_NSCHED_ENT (24424)
#define ERTS_ALC_T_MINDIRECTION (24552)
#define ERTS_ALC_T_THR_Q_EL_SL (24680)
#define ERTS_ALC_T_NIF_EXP_TRACE (24792)
#define ERTS_ALC_T_MONITOR (24920)
#define ERTS_ALC_T_LINK (25048)
#define ERTS_ALC_T_DRV_SEL_D_STATE (25192)
#define ERTS_ALC_T_NIF_SEL_D_STATE (25320)
#define ERTS_ALC_T_LITERAL (25401)
#define ERTS_ALC_T_HIPE_EXEC (25530)
#define ERTS_ALC_T_DRV_BINARY (25643)
#define ERTS_ALC_T_BINARY (25771)
#define ERTS_ALC_T_PORT (25964)
#define ERTS_ALC_T_DRV (26092)
#define ERTS_ALC_T_DRIVER (26220)
#define ERTS_ALC_T_DRV_CMD_DATA (26348)
#define ERTS_ALC_T_DRV_CTRL_DATA (26476)
#define ERTS_ALC_T_DRV_CALL_DATA (26604)
#define ERTS_ALC_T_NIF (26732)
#define ERTS_ALC_T_PORT_DATA_LOCK (26860)
#define ERTS_ALC_T_DRV_THR_OPTS (26988)
#define ERTS_ALC_T_DRV_TID (27116)
#define ERTS_ALC_T_DRV_MTX (27244)
#define ERTS_ALC_T_DRV_CND (27372)
#define ERTS_ALC_T_DRV_RWLCK (27500)
#define ERTS_ALC_T_DRV_TSD (27628)
#define ERTS_ALC_T_MSACC (27756)
#define ERTS_ALC_T_TEST (27885)
