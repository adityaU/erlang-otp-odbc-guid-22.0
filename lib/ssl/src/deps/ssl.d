...
$(EBIN)/dtls_record.$(EMULATOR): dtls_record.erl dtls_record.hrl ssl_record.hrl \
  ssl_internal.hrl ssl_alert.hrl dtls_handshake.hrl tls_handshake.hrl \
  ssl_handshake.hrl ssl_api.hrl ssl_cipher.hrl
...
$(EBIN)/ssl_alert.$(EMULATOR): ssl_alert.erl ssl_alert.hrl ssl_record.hrl ssl_internal.hrl
...
$(EBIN)/ssl_cipher.$(EMULATOR): ssl_cipher.erl ssl_internal.hrl ssl_record.hrl \
  ssl_cipher.hrl ssl_handshake.hrl ssl_alert.hrl tls_handshake_1_3.hrl \
  tls_handshake.hrl
...
$(EBIN)/ssl_crl.$(EMULATOR): ssl_crl.erl ssl_alert.hrl ssl_internal.hrl
...
$(EBIN)/ssl_handshake.$(EMULATOR): ssl_handshake.erl ssl_handshake.hrl ssl_record.hrl \
  ssl_cipher.hrl ssl_alert.hrl ssl_internal.hrl ssl_srp.hrl \
  tls_handshake_1_3.hrl tls_handshake.hrl
$(EBIN)/ssl_listen_tracker_sup.$(EMULATOR): ssl_listen_tracker_sup.erl
$(EBIN)/ssl_logger.$(EMULATOR): ssl_logger.erl tls_record.hrl ssl_record.hrl ssl_cipher.hrl \
  ssl_internal.hrl tls_handshake.hrl ssl_handshake.hrl dtls_handshake.hrl \
  ssl_api.hrl tls_handshake_1_3.hrl \
  ../../../bootstrap/lib/kernel/include/logger.hrl
...
$(EBIN)/tls_handshake_1_3.$(EMULATOR): tls_handshake_1_3.erl tls_handshake_1_3.hrl \
  tls_handshake.hrl ssl_handshake.hrl ssl_alert.hrl ssl_cipher.hrl \
  ssl_connection.hrl ssl_internal.hrl ssl_record.hrl ssl_srp.hrl
$(EBIN)/tls_record.$(EMULATOR): tls_record.erl tls_record.hrl ssl_record.hrl \
  ssl_internal.hrl ssl_alert.hrl tls_handshake.hrl ssl_handshake.hrl \
  ssl_cipher.hrl \
  ../../../bootstrap/lib/kernel/include/logger.hrl
$(EBIN)/tls_record_1_3.$(EMULATOR): tls_record_1_3.erl tls_record.hrl ssl_record.hrl \
  tls_record_1_3.hrl ssl_internal.hrl ssl_alert.hrl ssl_cipher.hrl
$(EBIN)/tls_sender.$(EMULATOR): tls_sender.erl ssl_internal.hrl ssl_alert.hrl \
  ssl_handshake.hrl ssl_api.hrl
